import './GymAboutSec.scss';

export default function GymAboutSec() {
  return (
    <div id="gym-about-sec" className="main-sec our-role-sec">
      <div className="container">
        <div className="secs-cont flx">
          <div className="vertical-sec img-sec"></div>
